                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.overlay}>
                        ...
                        >
                            {/* 바텀 시트 구성 부분 */}
                            <Text
                                style={{ width: 70, height: 40, marginBottom: '10%', marginTop: '5%' }}
                            />
                            ...
                            <View style={{ flexDirection: 'row', height: '15%', alignItems: 'center', justifyContent: 'center', width: '90%', marginRight: '50%'  }}>
                                {/* 텍스트 입력 부분 */}
                                <TextInput
                            ...
                            <Text style={{ fontSize: 18, fontWeight: 'bold', fontFamily: 'Play-Bold', color: '#383838', marginRight: '32%', marginTop: '2%' }}>※ 5인분 단위로 기부를 받을 수 있습니다.</Text>

                            {/* 확인 버튼 */}
                            <TouchableOpacity style={{ width: 360, height: 55, borderRadius: 22, marginTop: '55%', marginBottom: '15%', backgroundColor: '#44A5FF', alignItems: 'center', justifyContent: 'center' }} >
