      ...
      <ScrollView style={{ backgroundColor: '#FAFAFC', width: '89.5%', height: '80%' }}>
        <View>
          <View style={{ flexDirection: 'row' }}>
            <Text onPress={() => setModalVisible2(true)} style={{ fontFamily: 'Play-Bold', fontSize: 20, color: '#656565', marginTop: '2%', marginRight: '15%' }}>[야놀자] 100,000,000원</Text>
            <Image
        ...
        <View>
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ fontFamily: 'Play-Bold', fontSize: 20, color: '#656565', marginTop: '2%', marginRight: '10%' }}>[두꺼비 식당] 시금치 10인분</Text>
            <Image
              style={{ width: 20, height: 20, marginTop: '1.8%', marginLeft: '25%' }}
              source={require('../../assets/reviewoff.png')}
              resizeMode="contain"
            />
            <TouchableOpacity style={{ marginLeft: '5%', marginTop: '2.5%' }} onPress={pressButton}>
              <Image
          ...
          <Text style={{ fontFamily: 'Play-Regular', fontSize: 15, color: '#8B8E90', marginTop: '1%' }}>2023.11.07</Text>
          <View style={{ borderBottomWidth: 1, borderBottomColor: '#DBDBDB', width: '100%', marginTop: '5%' }} />
        </View>
      </ScrollView>
