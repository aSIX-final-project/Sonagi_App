...
const components = [
  { name: '공지사항', icon: 'notifications-outline', activeIcon: 'notifications', route: 'Route1_1' },
  { name: '기부내역', icon: 'bookmark-outline', activeIcon: 'bookmark', route: 'Route2_1' },
  { name: '홈', icon: 'home', activeIcon: 'home-outline', route: 'Route3_1' },
  { name: '기부받기', icon: 'map-outline', activeIcon: 'map', route: 'Route4_1' },
  { name: '보낸요청', icon: 'paper-plane-outline', activeIcon: 'paper-plane', route: 'Route5_1' },
];
    ...
    <View style={styles.container}>
      ...
      <View style={{ width: '100%', height: '10%', backgroundColor: '#44A5FF', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
        <Image
          ...
          resizeMode="contain"
        />
        <TouchableOpacity style={{ marginTop: '7%', width: '8%', height: '35%', left: '90%' }} onPress={() => navigation.navigate('Profilesp')}>
          <Image
      ...
      <View style={{ flexDirection: 'row', width: '90%', height: '10%', justifyContent: 'flex-start', alignItems: 'center', bottom: '0%' }}>
        <View style={{ marginLeft: '1%', marginTop: '5%' }}>
          ...
          <Text style={{ fontSize: 23, fontFamily: 'Play-Regular' }}>기부 받고 복 받아가세요!</Text>
        </View>
      </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={styles.fifthOneContainer}>
            <TouchableOpacity style={{ width: '100%' }} onPress={() => navigation.navigate('KakaoMapp')}>
              <View style={{ textAlign: 'left', width: '100%', marginLeft: '2%', marginBottom: '3%', marginTop: '3%' }}>
                <Text style={{ fontSize: 22, fontFamily: 'Play-Regular', color: '#3D3D3D', marginRight: '0%' }}>기부 받기</Text>
              </View>
              <Image
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 22, fontFamily: 'Play-Regular', color: '#3D3D3D', marginRight: '0%', marginTop: '0%', width: '87%', textAlign: 'left', marginBottom: '3%' }}>기부 받은 내역</Text>

            <TouchableOpacity style={{ marginBottom: '2%', marginRight: '63%', borderRadius: 15, backgroundColor: '#FFFFFF', padding: '2%', paddingHorizontal: '5%', }} onPress={() => navigation.navigate('Donatep')}>
          ...
          <View style={styles.fourthContainer}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              {/* 다섯번째 라인 (보낸 요청) */}
              <TouchableOpacity onPress={() => navigation.navigate('SendReqp')}>
                <View style={styles.fourthTwoContainer}>
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: '30%', marginTop: '18%', left: '3.5%' }}>
                    <Text style={{ fontSize: 22, fontFamily: 'Play-Regular', color: '#6F6A6A',marginRight: '17%', marginLeft: '0%' }}>보낸 요청</Text>
                    <Image
                      style={{ width: 50, height: 25, left: '10%' }}
                  ...
                  <View style={{ flexDirection: 'column', justifyContent: 'center', marginleft: '10%'  }}>
                    <Text style={{ fontSize: 18, fontWeight: 'bold', fontFamily: 'Play-Bold', color: '#3D3D3D' }}>이모네밥 김치 200인분</Text>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', fontFamily: 'Play-Regular', color: '#3D3D3D' }}>2023.11.10</Text>
                  </View>
                </View>
              </TouchableOpacity>
            </View>
