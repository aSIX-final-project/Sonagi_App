...
const BottomsheetMarker = ({ modalVisible, setModalVisible, navigation, id }) => {
                        ...
                        >
                            ...
                            <View style={{ marginTop: '30%', flexDirection: 'row', width: '90%', height: '8%', alignItems: 'center', marginBottom: '3%', paddingRight: '50%' }}>
                                ...
                                <View style={{ marginTop: '1%' }}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold', fontFamily: 'Play-Bold', width: 'auto' }}>
                                        {userData && userData[0]?.adName}
                                    </Text>
                                    <Text style={{ fontSize: 18, fontWeight: 'bold', fontFamily: 'Play-Regular', width: 'auto' }}>
                            ...
                            <View style={{ flexDirection: 'row', marginRight: '35%', marginTop: '2%' }}>
                                <Text style={{ fontSize: 15, fontWeight: 'bold', fontFamily: 'Play-Regular', marginRight: '10%' }}>
                                    총 인원: {userData && userData[0]?.totalHc}
                                </Text>
                                <Text style={{ fontSize: 15, fontWeight: 'bold', fontFamily: 'Play-Regular' }}>
                            ...
                            <View style={{ flexDirection: 'row', width: '90%', height: '17%', alignItems: 'center', marginTop: '10%', paddingRight: '40%' }}>
                                <View>
                                    <Text style={{ fontSize: 25, color: '#393939', fontWeight: 'bold', fontFamily: 'Play-Bold', marginBottom: '1%' }}>
                                        시설소개
                                    </Text>
                                    <Text style={{ fontSize: 18, color: '#6F6A6A', fontWeight: 'bold', fontFamily: 'Play-Regular', width: '55%' }}>
                            ...
                            <View style={{ marginBottom: '25%', width: '90%', height: '20%', flexDirection: 'row', alignItems: 'center' }}>
                                <TouchableOpacity style={{ width: '48%', height: '70%', backgroundColor: '#E1F1FF', borderRadius: 26, alignItems: 'center', justifyContent: 'center' }} onPress={() => kakaoMap(/* provide your coordinates here */)}>
                                    <Text style={{ fontSize: 32, fontWeight: 'bold', fontFamily: 'Play-Bold', color: '#44A5FF' }}>길찾기</Text>
                                </TouchableOpacity>

                                <TouchableOpacity style={{ width: '48%', height: '70%', backgroundColor: '#44A5FF', borderRadius: 26, alignItems: 'center', justifyContent: 'center', marginLeft: '4%' }} onPress={() => callPhone(userData && userData[0]?.phoneNum)}>
