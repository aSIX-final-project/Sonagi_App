...
const Mapadd = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', width: '90%', height: '10%', alignItems: 'center', backgroundColor: '#FFFFFF', marginTop: '30%', paddingRight: '50%' }}>
                <View>
                    <Image
                ...
                <View style={{ marginTop: '1%' }}>
                    <Text style={{ fontSize: 25, fontWeight: 'bold', fontFamily: 'Play-Bold' }}>상호명:명륜 보육원</Text>
            ...
            {/* 밑줄 밑 시설소개 */}
            <View style={{ flexDirection: 'row', width: '90%', height: '20%', alignItems: 'center', backgroundColor: '#FFFFFF', marginTop: '0%', paddingRight: '40%' }}>

                <View style={{ marginTop: '1%' }}>
                    <Text style={{ fontSize: 40, fontWeight: 'bold', fontFamily: 'Play-Bold', marginBottom: '5%' }}>시설소개</Text>
                    <Text style={{ fontSize: 26, fontWeight: 'bold', fontFamily: 'Play-Regular', width: '55%' }}>우리 OO 시설은 50명의 아동을 수용중이며 서울시에서 가장 큰 규모로 운영중입니다.</Text>
                </View>
            </View>

            {/* 하단 버튼 */}
            <View style={{ width: '90%', height: '30%', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', marginTop: '0%', paddingRight: '0%', paddingRight: '0%' }}>

                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginTop: '60%' }}>
                    <Image
                        style={{ width: 27, height: 27, marginBottom: '1%', marginRight: '1%' }}
                        source={require('../../assets/food.png')}
                        resizeMode="contain"
                    />
                    <Text style={{ fontSize: 25, fontWeight: 'bold', fontFamily: 'Play-Bold', color: '#383838' }} onPress={pressButton}>음식 설정하기</Text>
                </TouchableOpacity>
            </View>
            <View style={{ width: '90%', height: '10%', flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF' }}>
                ...
                <TouchableOpacity style={{ width: '48%', height: '70%', backgroundColor: '#44A5FF', borderRadius: 26, alignItems: 'center', justifyContent: 'center', marginLeft: '4%' }} onPress={() => navigation.navigate('Login')}>
                    <Text style={{ fontSize: 32, fontWeight: 'bold', fontFamily: 'Play-Bold', color: '#FFFFFF' }}>보내기</Text>
                </TouchableOpacity>
            </View>
