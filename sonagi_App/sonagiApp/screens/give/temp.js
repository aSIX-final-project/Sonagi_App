...
const BottomsheetModDel = ({
  ...
  const [ReivewData, setReivewData] = useState(null);
  console.log("eqwrqwrqwr: ", selectedDonation);
  ...
  useEffect(() => {
    if (modalVisible) {
      ...
      const formData = {
        receiver: selectedDonation.donatedReceiver,
        donator: selectedDonation.donatedProvider,
        reviewTitle: selectedDonation.foodTitle,
      };
          ...
          <View style={styles.centeredView2}>
            <View style={styles.modalView2}>
              ...
              <View style={{ justifyContent: "center", alignItems: "center" }}>
                ...
                >
                  <Image
                    source={{ uri: ReivewData.foodImage }}
              ...
              <TextInput
                ...
                multiline={true}
                numberOfLines={10}
                value={ReivewData.reviewContext}
              ></TextInput>
