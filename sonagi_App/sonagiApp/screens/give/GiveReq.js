...
const GiveReq = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* 상단부분 */}
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#44A5FF', width: '100%', height: '12%', paddingTop: '7%', }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: '4%' }}>
                    <TouchableOpacity style={{ marginLeft: '6%', marginRight: '2%' }} onPress={() => navigation.navigate('Home',{userInfo:userInfo})}>
                        <Image
                    ...
                    <View style={{ width: '100%', height: '100%', backgroundColor: '#E1F1FF', flexDirection: 'row', borderRadius: 30, flexDirection: 'column'}}>
                        <View style={{ flexDirection: 'row' }}>
                            <Image
                                ...
                                resizeMode="contain"
                            />
                            <View style={{ width: '57%', height: '60%', backgroundColor: '#E1F1FF', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: '4%' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                            <TouchableOpacity style={{ backgroundColor: '#44A5FF', width: '50%', height: '100%', borderBottomLeftRadius: 30 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                                    <Image
                                        style={{ width: 30, height: 30, borderTopLeftRadius: 30, marginBottom: '2%' }}
                                        source={require('../../assets/check.png')}
                                        resizeMode="contain"
                                    />
                                    <Text style={{ fontSize: 20, fontFamily: 'Play-Regular', color: '#ffffff', marginLeft: '3%' }}>확인</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity style={{ backgroundColor: '#E1F1FF', width: '50%', height: '100%', borderBottomRightRadius: 30 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                                    <Image
                                        ...
                                        resizeMode="contain"
                                    />
                                    <Text style={{ fontSize: 20, fontFamily: 'Play-Regular', color: '#44A5FF', marginLeft: '3%' }}>취소</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                    </View>
