...
const BottomsheetMarkerFoodSelect = ({
  modalVisible,
  setModalVisible,
  navigation,
  id,
  ...
  console.log("BottomsheetMarkerFoodSelect");
            ...
            >
              <View style={{ flex: 1 }}>
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <TouchableOpacity
                      onPress={() =>{ closeModal(); navigation.navigate("GiveMapConnect", { id: id, userInfo: userInfo, foodName: item.foodName })}}
...
export default BottomsheetMarkerFoodSelect;
