...
const components = [
  { name: '공지사항', icon: 'notifications-outline', activeIcon: 'notifications', route: 'Route1' },
  { name: '기부내역', icon: 'bookmark-outline', activeIcon: 'bookmark', route: 'Route2' },
  { name: '홈', icon: 'home', activeIcon: 'home-outline', route: 'Route3' },
  { name: '기부하기', icon: 'map-outline', activeIcon: 'map', route: 'Route4' },
  { name: '기부요청', icon: 'star-outline', activeIcon: 'star', route: 'Route5' },
];
    ...
    <View style={styles.container}>
      ...
      <View style={{ width: '100%', height: '10%', backgroundColor: '#44A5FF', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
        <Image
          ...
          resizeMode="contain"
        />
        <TouchableOpacity style={{ marginTop: '7%', width: '8%', height: '35%', left: '90%' }} onPress={() => navigation.navigate('Profiles')}>
          <Image
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={styles.fifthOneContainer}>
            <TouchableOpacity style={{ width: '100%' }} onPress={() => navigation.navigate('KakaoMap')}>
          ...
          <View style={{
            ...
            <TouchableOpacity style={{ marginBottom: '2%', marginRight: '63%', borderRadius: 15, backgroundColor: '#FFFFFF', padding: '2%', paddingHorizontal: '5%', }} onPress={() => navigation.navigate('Donate')}>
          ...
          <View style={styles.fourthContainer}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              {/* 다섯번째 라인 (기부 요청) */}
              <TouchableOpacity onPress={() => navigation.navigate('GiveReq')}>
