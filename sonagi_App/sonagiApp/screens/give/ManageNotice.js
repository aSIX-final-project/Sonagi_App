        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.centeredView2}>
                    <View style={styles.modalView2}>
                        {/* 게시판 모달 관련 코드 */}
                        <TouchableOpacity style={{ width: '10%', left: '48%' }} onPress={() => setNotionModalVisible2(false)}>
                            <View style={{ marginBottom: '10%' }}>
                                <Image
                                    style={{ width: 20, height: 20,  }}
                                    source={require('../../assets/cancle.png')}
            ...
            <View style={{ backgroundColor: '#44A5FF', width: '100%', height: '40%', borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#44A5FF', width: '100%', height: '17%', marginTop: '10%' }}>
                    ...
                    <Text style={{ fontFamily: 'Play-Bold', fontSize: 25, color: 'white' }}>공지사항</Text>
                    
                    {/* 등록 버튼 */}
                    <TouchableOpacity style={{ marginTop: '2%', marginLeft: '0%', width: '25%', height: '100%', marginLeft: '33%', borderRadius: 15, justifyContent: 'center', alignItems: 'center' }} onPress={handleNotionButtonClick}>
                        <Image
            ...
            <ScrollView style={{ backgroundColor: '#FFFFFF', width: '89.5%', height: '80%' }}>
                <TouchableOpacity style={{ flexDirection: 'column', paddingBottom: '5%', }} onPress={handleNotionButtonClick2}>
                    
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={{ fontFamily: 'Play-Bold', fontSize: 20, color: '#656565', marginTop: '2%' }}>[공지]23시-03시 정기 점검 예정</Text>
                    

                    <TouchableOpacity style={{ marginLeft: '35%', marginTop: '2.5%', marginRight: 10,paddingTop: '2%', paddingBottom: '2%',marginTop: '1%', paddingHorizontal: '2%' }} onPress={pressButton}>
                        <Image
