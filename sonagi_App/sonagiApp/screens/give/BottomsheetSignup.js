                ...
                <View style={styles.overlay}>
                    ...
                    >
                        ...
                        <ScrollView contentContainerStyle={styles.scrollViewContainer} style={{ width: '100%', height: '60%' }}>
                            ...
                            {/* 선 긋기 */}
                            <View style={styles.lineStyle} />
                            {businessNumberError && <Text style={styles.errorText6}>올바른 사업자 등록번호를 입력하세요</Text>}
                            {/* ///////////////////////////////////////////////////////////// */}
                        ...
                        >
                            <Image
                                style={{ width: 350, height: 100, top: '20%', right: '0%', marginRight: 10 }}
                                source={require('../../assets/signupbutton.png')}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
                        {/* 로그인으로 넘어가는 부분 */}
                        <View style={{ flexDirection: 'row', alignItems: 'center', right: '1.5%', bottom: '10%', paddingTop: 0 }}>
                            <Image
                            ...
                            >
                                <View style={styles.centeredView}>
                                    <View style={styles.modalView}>
                                        ...
                                        >
                                            <Image
                                                style={{ width: 120, height: 120, bottom: '0.5%', margin: '5%' }}
